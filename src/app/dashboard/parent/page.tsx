...
export default async function ParentDashboardPage() {
  ...
  // Fetch subjects in this institution to represent child's assigned courses
  ...
  return (
    <ParentDashboardClient
      parent={{ name: profile.name ?? user.email ?? "Parent", email: user.email ?? "", institution: institution?.name ?? "Institution" }}
