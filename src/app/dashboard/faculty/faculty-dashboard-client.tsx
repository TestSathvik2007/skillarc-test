...
export default function FacultyDashboardClient({
  ...
  faculty: { email: string; institution: string }
  subjects: Subject[]
  studentCount: number
}) {
  ...
  const quickActions = [
    { label: "My Subjects",  desc: "View assigned subjects",  icon: "📘", href: "/dashboard/faculty/subjects" },
    { label: "Timetable",    desc: "View your schedule",      icon: "📅", href: "/dashboard/timetable-builder" },
    { label: "Students",     desc: "View your students",      icon: "👩‍🎓", href: "/dashboard/faculty/students" },
    { label: "Attendance",   desc: "Mark attendance",         icon: "✅", href: "/dashboard/faculty/attendance" },
  ]
